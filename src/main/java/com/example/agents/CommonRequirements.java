...
public interface CommonRequirements {
    ...
    record Dealer(String id, String name, String location) {}
    ...
    record VehicleAvailability(
            String vehicleId, String dealerId, boolean inStock, int quantity, String estimatedDelivery) {}
    ...
    record VehicleComparison(
            List<VehicleInfo> vehicles, List<String> comparisonCategories, List<ComparisonPoint> comparisonPoints) {}

    record ComparisonPoint(String category, String vehicleId, String value) {}
    ...
    record VehicleTradeIn(
            VehicleMake make, String model, int year, int mileage, String condition, List<String> issues) {}
    ...
    record MarketConditions(
            String inventoryLevel, String demandLevel, boolean endOfMonth, boolean endOfYear, String season) {}
    ...
    interface Tools {
        ...
        TestDriveAppointment scheduleTestDrive(
