    ...
    static class EVTools extends BaseToolLogger {
        ...
        public List<ChargingStation> findChargingStations(
            ...
            if (stations.isEmpty()) {
                ...
                for (ChargingStation station : stations) {
                    ...
                    sb.append(String.format(
                            "  Type: %s | Network: %s | Ports: %d | Cost: $%.2f/kWh\n",
        ...
        public RangeEstimate estimateRange(
            ...
            sb.append("Parameters: vehicleId=")
                    ...
                    .append("°F")
                    .append(", highway=")
                    .append(highwayPercentage)
                    .append("%")
                    .append(", climate=")
                    .append(useClimate ? "on" : "off")
                    .append("\n");
            ...
            if (range == null) {
                ...
                sb.append(String.format(
                        "Range Reduction: %.0f%% (%.0f miles)\n",
                        (range.rangeReduction() * 100), range.baseRange() - range.adjustedRange()));
                sb.append("Affecting Factors: ")
                        .append(String.join(", ", range.affectingFactors()))
                        .append("\n");
